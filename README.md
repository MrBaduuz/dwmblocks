...
Originally inspired by [Luke Smith's build](https://github.com/LukeSmithxyz/dwmblocks).
Scripts from my dotfiles and the Symbols Nerd Font is required for proper usage.
